...
rbd_df = pd.read_csv('c:/Users/Rodrigo/Desktop/Roxana Files/webscraping RBD/missing_rbds.csv')
rbd_list = rbd_df['RBD'].tolist()

# Read RBDs from resultados.csv
resultados_df = pd.read_csv('c:/Users/Rodrigo/Desktop/Roxana Files/webscraping RBD/resultados_nongse.csv')
...
missing_rbds_df.to_csv('c:/Users/Rodrigo/Desktop/Roxana Files/webscraping RBD/missing_rbds_nongse.csv', index=False)
